...
struct SortedArray<Element> {
    ...
    init<S: Sequence>(unsorted: S, areInIncreasingOrder: @escaping Comparator) where S.Iterator.Element == Element {
    ...
    init<S: Sequence>(sorted: S, areInIncreasingOrder: @escaping Comparator) where S.Iterator.Element == Element {
...
extension SortedArray: RandomAccessCollection {
    ...
    mutating func replaceSortedElement(at index: Index, with element: Element) {
    ...
    func sortedFilter(_ isIncluded: (Element) throws -> Bool) rethrows -> SortedArray<Element> {
...
extension SortedArray {
    ...
    func anyIndex(of element: Element) -> Index? {
...
func ==<Element: Equatable> (lhs: SortedArray<Element>, rhs: SortedArray<Element>) -> Bool {
